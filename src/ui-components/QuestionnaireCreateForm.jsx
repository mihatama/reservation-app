...
export default function QuestionnaireCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPlaceOfVisit(initialValues.placeOfVisit);
    setMamaLastName(initialValues.mamaLastName);
    setMamaFirstName(initialValues.mamaFirstName);
    setMamaFuriganaLastName(initialValues.mamaFuriganaLastName);
    setMamaFuriganaFirstName(initialValues.mamaFuriganaFirstName);
    setMamaBirthYear(initialValues.mamaBirthYear);
    setMamaBirthMonth(initialValues.mamaBirthMonth);
    setMamaBirthDay(initialValues.mamaBirthDay);
    setChildLastName(initialValues.childLastName);
    setChildFirstName(initialValues.childFirstName);
    setChildFuriganaLastName(initialValues.childFuriganaLastName);
    setChildFuriganaFirstName(initialValues.childFuriganaFirstName);
    setChildBirthYear(initialValues.childBirthYear);
    setChildBirthMonth(initialValues.childBirthMonth);
    setChildBirthDay(initialValues.childBirthDay);
    setChildOrder(initialValues.childOrder);
    setChildSex(initialValues.childSex);
    setOccupation(initialValues.occupation);
    setPostpartumStatus(initialValues.postpartumStatus);
    setHomePostalCode(initialValues.homePostalCode);
    setHomeAddress(initialValues.homeAddress);
    setRikaeriPostalCode(initialValues.rikaeriPostalCode);
    setRikaeriAddress(initialValues.rikaeriAddress);
    setDeliveryMethod(initialValues.deliveryMethod);
    setDeliveryWeek(initialValues.deliveryWeek);
    setBirthWeight(initialValues.birthWeight);
    setDischargeWeight(initialValues.dischargeWeight);
    setDischargeDate(initialValues.dischargeDate);
    setMeasurement1Date(initialValues.measurement1Date);
    setMeasurement1(initialValues.measurement1);
    setMeasurement2Date(initialValues.measurement2Date);
    setMeasurement2(initialValues.measurement2);
    setPregnancyCondition(initialValues.pregnancyCondition);
    setPastMedicalHistory(initialValues.pastMedicalHistory);
    setMedication(initialValues.medication);
    setInfectionHistory(initialValues.infectionHistory);
    setFamilyHistory(initialValues.familyHistory);
    setVisitReason(initialValues.visitReason);
    setAdditionalNotes(initialValues.additionalNotes);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Questionnaire(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "QuestionnaireCreateForm")}
      {...rest}
    >
      <TextField
