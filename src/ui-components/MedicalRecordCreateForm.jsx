...
export default function MedicalRecordCreateForm(props) {
  ...
  const resetStateValues = () => {
    setRecordNo(initialValues.recordNo);
    setRecordMonth(initialValues.recordMonth);
    setRecordDay(initialValues.recordDay);
    setPlace(initialValues.place);
    setStaffName(initialValues.staffName);
    setTraineeName(initialValues.traineeName);
    setChildName(initialValues.childName);
    setChildAgeYears(initialValues.childAgeYears);
    setChildAgeMonths(initialValues.childAgeMonths);
    setChildAgeDays(initialValues.childAgeDays);
    setWeight(initialValues.weight);
    setWeightGain(initialValues.weightGain);
    setBreastInterval(initialValues.breastInterval);
    setFormula(initialValues.formula);
    setExpressedMilk(initialValues.expressedMilk);
    setBabyFood(initialValues.babyFood);
    setStoolCount(initialValues.stoolCount);
    setUrineCount(initialValues.urineCount);
    setChildDevelopment(initialValues.childDevelopment);
    setWeaningStatus(initialValues.weaningStatus);
    setDayCount(initialValues.dayCount);
    setBreastShape(initialValues.breastShape);
    setNippleUsage(initialValues.nippleUsage);
    setExpressionTimes(initialValues.expressionTimes);
    setExpressionTool(initialValues.expressionTool);
    setNippleCondition(initialValues.nippleCondition);
    setPain(initialValues.pain);
    setBreastfeedingPosition(initialValues.breastfeedingPosition);
    setFamilySupport(initialValues.familySupport);
    setOMemo(initialValues.oMemo);
    setSMemo(initialValues.sMemo);
    setPMemo(initialValues.pMemo);
    setBreastDiagnosis(initialValues.breastDiagnosis);
    setPaymentMethod(initialValues.paymentMethod);
    setAdditionalFees(initialValues.additionalFees);
    setOtherNotes(initialValues.otherNotes);
    setErrors({});
  };
  const validations = {
    recordNo: [],
